  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary-light text-primary-foreground hover:bg-primary hover:shadow-xl transform hover:scale-105 font-medium tracking-wide",
        primary: "bg-primary text-primary-foreground hover:bg-primary-light hover:shadow-lg transform hover:scale-105",
        cta: "bg-accent text-accent-foreground hover:bg-accent/90 hover:shadow-lg transform hover:scale-105 font-semibold",
      },
      size: {
