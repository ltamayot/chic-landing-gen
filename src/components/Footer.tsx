...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-l from-[#DD6D5F]/90 to-[#DD6D5F]/70 text-primary-foreground py-16">
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-8">
              <button 
                ...
                className="text-primary-foreground hover:text-white transition-colors text-lg font-medium"
              >
                NUESTRO MÉTODO
              </button>
              <a 
